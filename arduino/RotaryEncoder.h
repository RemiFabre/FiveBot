...
class RotaryEncoder {
     ...
     */
    RotaryEncoder(volatile unsigned char& ddr, unsigned char pinA, unsigned char pinB, unsigned char pcie, volatile unsigned char& pcmsk, unsigned char pcintA, unsigned char pcintB);
